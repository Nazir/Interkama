...
Так как полученные от Гордеева С.И. данные плохо структурированы, ведутся им индивидуально и имеется проблема с переносом данных из «Примечания» в ячейке, мною было решено написать продукт, который бы получил бы данные корректно! Для удобства работы с данными и с необходимостью получения данных из «Примечания» в ячейке, файл Microsoft Excel (программный продукт фирмы Microsoft для работы с электронными таблицами) был преобразован в Microsoft Excel 2003 XML. После этого был разработан программный продукт, который извлекает все необходимые поля из файла и формирует набор данных в CSV формате (сокр. от comma-separated value - значения, разделяемые запятой). Для более быстрой разработки программы, файл Microsoft Excel 2003 XML был приведён к обычному XML формату (англ. сокр. Extensible Markup Language– расширяемый язык разметки).  
